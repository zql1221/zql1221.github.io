...
class udSDKJS_ProjectNode {
  ...
  //!
  //! @return {number} The id of the node type, see udProjectNodeType for more information.
  //!
  get itemtype() {
  ...
  //! Get the type of this node.
  //!
  //! @return {string} The id of the node type, see udProjectNodeType for more information.
  //!
  get itemtypeStr() {
  ...
  //!
  //! @return {number} A code representing the geometry type. See udProject.h to interpret this code.
  //!
  get geomtype() {
  ...
  //!                          For more information, see udProject.h : udProjectGeometryType
  //!
