...
void main()
{
    ...
    mat4 _129 = mat4(((_79[0] + _86[0]) + _105[0]) + _120[0], ((_79[1] + _86[1]) + _105[1]) + _120[1], ((_79[2] + _86[2]) + _105[2]) + _120[2], ((_79[3] + _86[3]) + _105[3]) + _120[3]);
    vec4 _130 = vec4(in_var_POSITION, 1.0) * _129;
    ...
    vec3 _199 = normalize((vec4(normalize((vec4(in_var_NORMAL, 0.0) * mat4(((_147[0] + _150[0]) + _165[0]) + _176[0], ((_147[1] + _150[1]) + _165[1]) + _176[1], ((_147[2] + _150[2]) + _165[2]) + _176[2], ((_147[3] + _150[3]) + _165[3]) + _176[3])).xyz), 0.0) * u_EveryFrame.u_NormalMatrix).xyz);
    vec3 _213 = normalize((vec4(normalize((vec4(in_var_TANGENT.xyz, 0.0) * _129).xyz), 0.0) * u_EveryFrame.u_NormalMatrix).xyz);
    vec4 _220 = _130 * u_EveryFrame.u_ModelViewProjectionMatrix;
    vec2 _234;
    do
    {
        ...
        _234 = vec2(1.0 + _220.w, 0.0);
        break;
    } while(false);
    gl_Position = _220;
    varying_POSITION0 = _131.xyz / vec3(_131.w);
    varying_POSITION1 = _138.xyz / vec3(_138.w);
    varying_NORMAL = mat3(_213, cross(_199, _213) * in_var_TANGENT.w, _199);
    varying_TEXCOORD0 = in_var_TEXCOORD0;
    varying_TEXCOORD1 = vec2(0.0);
    varying_TEXCOORD2 = _234;
