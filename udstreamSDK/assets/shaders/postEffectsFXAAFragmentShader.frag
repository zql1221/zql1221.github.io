...
void main()
{
    ...
    do
    {
        ...
        if (_152)
        {
            _161 = u_params.u_screenParams.y;
        }
        else
        {
            _161 = u_params.u_screenParams.x;
        }
        ...
        highp float _179 = _155 ? 0.0 : u_params.u_screenParams.x;
        highp float _181 = _152 ? 0.0 : u_params.u_screenParams.y;
        highp vec2 _187;
        if (_155)
        {
            highp vec2 _186 = _77;
    ...
    out_var_SV_Target0 = vec4(_486.xyz, 1.0);
