...
void main()
{
    ...
    vec4 _127 = vec4(in_var_POSITION, 1.0) * mat4(((_76[0] + _83[0]) + _102[0]) + _117[0], ((_76[1] + _83[1]) + _102[1]) + _117[1], ((_76[2] + _83[2]) + _102[2]) + _117[2], ((_76[3] + _83[3]) + _102[3]) + _117[3]);
    ...
    vec4 _199 = _127 * u_EveryFrame.u_ModelViewProjectionMatrix;
    vec2 _213;
    do
    {
        ...
        _213 = vec2(1.0 + _199.w, 0.0);
        break;
    } while(false);
    gl_Position = _199;
    varying_POSITION0 = _128.xyz / vec3(_128.w);
    varying_POSITION1 = _135.xyz / vec3(_135.w);
    varying_NORMAL = normalize((vec4(normalize((vec4(in_var_NORMAL, 0.0) * mat4(((_144[0] + _147[0]) + _162[0]) + _173[0], ((_144[1] + _147[1]) + _162[1]) + _173[1], ((_144[2] + _147[2]) + _162[2]) + _173[2], ((_144[3] + _147[3]) + _162[3]) + _173[3])).xyz), 0.0) * u_EveryFrame.u_NormalMatrix).xyz);
    varying_TEXCOORD0 = in_var_TEXCOORD0;
    varying_TEXCOORD1 = in_var_TEXCOORD1;
    varying_TEXCOORD2 = _213;
